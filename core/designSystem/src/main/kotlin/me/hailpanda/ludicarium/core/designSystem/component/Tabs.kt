    ...
    Tab(
        ...
        text = {
            ...
            ProvideTextStyle(
                value = style,
                content = {
                    Box(modifier = Modifier.padding(top = LudicariumTabDefaults.TabTopPadding)) {
                        text()
                    }
                },
            )
...
fun TabsPreview() {
    LudicariumTheme {
        ...
        LudicariumTabRow(selectedTabIndex = 0) {
